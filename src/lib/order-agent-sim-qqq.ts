 ...
 *
 * Built from scratch 2026-04-28 alongside the QQQ strategy rebuild. QQQ trades
 * around $480-520 (~0.85x SPY, comparable absolute price tier) with thick
 * options liquidity — third most-traded ETF after SPY and IWM. Premium floor
 * multiplier set to 5x (same as SPY) — tight spreads + deep open interest let
 * us trail aggressively without slippage. QQQ ATM weeklies typically run
 * ~$3.50-7 (slightly wider than SPY due to higher implied vol on tech basket).
 */
